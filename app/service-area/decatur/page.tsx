...
export const metadata: Metadata = {
  ...
  description: '2M Construction provides licensed fencing, decking, roofing, painting, flooring & remodeling services in Decatur, AL (35601). Free estimates. Call (938) 302-6795.',
    ...
    <div style={{ maxWidth:'800px', margin:'0 auto', padding:'24px 16px' }}>
      ...
      <div style={{ background:'#F8FAFC', border:'1px solid #E2E8F0', borderRadius:'12px', padding:'20px', marginBottom:'24px' }}>
        ...
        <ul style={{ margin:0, paddingLeft:'20px', color:'#475569', fontSize:'14px', lineHeight:2 }}>
          ...
          <li>Serving Decatur and Morgan County since 2026</li>
