...
export default function MadisonServiceArea() {
  return (
    <div style={{ maxWidth:'800px', margin:'0 auto', padding:'24px 16px' }}>
      <p style={{ fontSize:'13px', color:'#64748B', marginBottom:'8px' }}>
        <Link href="/" style={{ color:'#64748B' }}>Home</Link> › <Link href="/service-area" style={{ color:'#64748B' }}>Service Areas</Link> › Madison
      </p>

      <h1 style={{ fontWeight:800, fontSize:'26px', color:'#1E293B', margin:'0 0 8px' }}>
        Construction Services in Madison, AL
      </h1>
      <p style={{ color:'#64748B', fontSize:'15px', margin:'0 0 24px', lineHeight:1.6 }}>
        2M Construction is one of the fastest-growing cities in Alabama serving Madison and surrounding Madison County communities.
      ...
      <div style={{ background:'linear-gradient(135deg,#1A3A5C,#0F2542)', borderRadius:'16px', padding:'24px', marginBottom:'24px', color:'#fff' }}>
        <h2 style={{ fontWeight:800, fontSize:'18px', margin:'0 0 8px' }}>Free Estimates in Madison</h2>
        <p style={{ color:'rgba(255,255,255,0.8)', margin:'0 0 16px', fontSize:'14px' }}>
          Serving 35758 and surrounding areas. Licensed & insured in Alabama.
        </p>
      ...
      <div style={{ background:'#F8FAFC', border:'1px solid #E2E8F0', borderRadius:'12px', padding:'20px', marginBottom:'24px' }}>
        <h3 style={{ fontWeight:700, fontSize:'16px', color:'#1E293B', margin:'0 0 12px' }}>Why Choose 2M Construction in Madison?</h3>
        <ul style={{ margin:0, paddingLeft:'20px', color:'#475569', fontSize:'14px', lineHeight:2 }}>
          <li>Licensed & insured Alabama contractor</li>
          <li>Serving Madison and Madison County since 2010</li>
      ...
      <div style={{ textAlign:'center', padding:'24px', background:'#fff', border:'1px solid #E2E8F0', borderRadius:'12px' }}>
        <h3 style={{ fontWeight:700, fontSize:'16px', color:'#1E293B', margin:'0 0 8px' }}>Ready to start your project in Madison?</h3>
