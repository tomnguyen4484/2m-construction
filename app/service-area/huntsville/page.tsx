...
export const metadata: Metadata = {
  ...
  description: '2M Construction provides licensed fencing, decking, roofing, painting, flooring & remodeling services in Huntsville, AL (35801). Free estimates. Call (256) 555-1234.',
    ...
    <div style={{ maxWidth:'800px', margin:'0 auto', padding:'24px 16px' }}>
      ...
      <div style={{ background:'#F8FAFC', border:'1px solid #E2E8F0', borderRadius:'12px', padding:'20px', marginBottom:'24px' }}>
        ...
        <ul style={{ margin:0, paddingLeft:'20px', color:'#475569', fontSize:'14px', lineHeight:2 }}>
          ...
          <li>Serving Huntsville and Madison County since 2010</li>
