...
export default function AboutPage() {
  return (
    <main style={{ fontFamily: 'sans-serif', color: '#1a1a1a' }}>
      ...
      <section style={{ background: '#ffffff', padding: '72px 24px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#374151' }}>
            ...
            Whether it is a small repair or a large renovation, we treat every project like it is our own home.
          </p>
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 24 }}>
            {[
              ...
              <div key={v.title} style={{
                ...
                textAlign: 'left', borderTop: '4px solid #F5C518',
      ...
      <section style={{ background: '#ffffff', padding: '72px 24px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <p style={{ color: '#F5C518', fontWeight: 700, fontSize: 13, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 24 }}>Meet the Owner</p>
          <div style={{ display: 'flex', gap: 40, alignItems: 'center', flexWrap: 'wrap' }}>
            <div style={{
              width: 160, height: 160, borderRadius: '50%',
              background: '#1A3A5C', display: 'flex', alignItems: 'center',
              justifyContent: 'center', flexShrink: 0,
              color: '#F5C518', fontSize: 48, fontWeight: 800,
            }}>
              TN
            </div>
