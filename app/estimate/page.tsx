    ...
    <main style={{ minHeight:'100vh', paddingTop:'80px', paddingBottom:'60px', color:'#E2E8F0' }}>
      <div style={{ maxWidth:'800px', margin:'0 auto', padding:'0 16px' }}>
        ...
        <div style={{ textAlign:'center', marginBottom:'44px' }}>
          ...
          <p style={{ color:'#CBD5E1', fontSize:'14px', maxWidth:'440px',
          ...
          {SERVICES.map((s, i) => (
            <Link key={s.href} href={s.href} style={{ textDecoration:'none' }}>
              <div style={{
                ...
                background:'rgba(26,58,92,0.85)', borderRadius:'10px', padding:'18px 22px',
                border:'1px solid #2D4F73', borderLeft:'3px solid #F5C518',
              }}>
                <div style={{ display:'flex', alignItems:'center', gap:'16px' }}>
                  <span style={{ color:'#F5C518', fontSize:'13px', fontWeight:700,
                    minWidth:'24px', opacity:0.6 }}>{String(i+1).padStart(2,'0')}</span>
                  <div>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'12px' }}>
                  <span style={{ color:'#CBD5E1', fontSize:'11px',
                    background:'rgba(15,37,66,0.7)', padding:'3px 8px', borderRadius:'6px',
        ...
        <div style={{ background:'rgba(26,58,92,0.85)', borderRadius:'12px', padding:'24px',
